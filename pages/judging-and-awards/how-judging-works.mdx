...
During the initial judging round, judges will review all [submissions](/project-guidelines/submission) and score them based on the [WildHacks project evaluation criteria](/judging-and-awards/project-evaluation). Each project will have multiple judges assigned to it and the average score will be used as the project's final score for round 1. The top 10 projects (or more in the case of ties) will move on to round 2. Judges do this privately, and the optional [Crowd Favorite](#crowd-favorite) presentations will take place during this time.

### Round 2 - Live Presentations

The teams with the top-scoring projects will be invited to present their projects to the judges (and other hackers) in a live presentation. Rather than a short video pitch that emphasizes both a quick demo and discussion of the problem and tech stack, the live presentations focus more on a deep demo of the project's functionality and serve as an interactive way for judges to evaluate the projects. Each team will have around 5 minutes total to present their project with judges able to freely ask questions. All judges review all top projects and will select the winning teams, which will be announced during the closing ceremony.
