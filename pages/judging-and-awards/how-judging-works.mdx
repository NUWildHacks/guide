...
The teams with the top-scoring projects will be invited to present their projects to the judges (and other hackers) in a live presentation. Rather than a short video pitch that emphasizes both a quick demo and discussion of the problem and tech stack, the live presentations focus more on a deep demo of the project's functionality and serve as an interactive way for judges to evaluate the projects. Each team will have 5 minutes total to present their project and judge Q+A. All judges review all top projects and will select the winning teams, which will be announced during the closing ceremony. The highest and lowest scores will be dropped from each team, with the remaining scores averaged.
