...
The hack should be unique and interesting. It should also relate to the specified track in some way. This can range from a new spin on a known idea to completely outlandish ideas. The hack should be something cool really cool.
