...
Each project is judged individually 3 times by 3 different judges. Judges are assigned so that they do not judge the same project more than once and to minimize the number of projects that the same group of 3 judges judge together.
