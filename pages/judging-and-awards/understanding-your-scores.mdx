...
These scores are awarded by 8 judges split so that each project is judged individually 3 times by 3 different judges. Judges are assigned so that they do not judge the same project more than once and to minimize the number of projects that the same group of 3 judges judge together.
...
The top 10 projects based on score were selected for round 2. In that group, the highest score was 83.33 and the lowest score was 69.67.
