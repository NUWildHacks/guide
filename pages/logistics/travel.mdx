...
WildHacks is held on the **Northwestern University** campus in Evanston, IL, just north of Chicago. Specifically, the **Technological Institute**.
...
You can take the **[Pulse Dempster Line](https://www.pacebus.com/project/pulse-dempster-line)** all the way from **O'Hare MMF Bay 9** to **Davis CTA Station**. This is not too long and is only about $2.00.

You can also a rideshare app like **Uber** or **Lyft** is the fastest but most expensive.
