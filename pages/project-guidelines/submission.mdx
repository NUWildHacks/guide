...
Submission is done on [DevPost](wildhacks-2025.devpost.com). [Teams](/project-guidelines/team-guidelines) of up to 4 are allowed to submit to one of 3 [tracks](/project-guidelines/tracks-and-challenges) that are released when hacking begins.
...
<Callout type="warning">
  For 2025, Round 1 videos may not use a slide deck or extraneous editing. We encourage WildHackers to focus on their application.
</Callout>

## Submission Instructions

<Steps>
### 1) Create a [DevPost](wildhacks-2025.devpost.com) Account
