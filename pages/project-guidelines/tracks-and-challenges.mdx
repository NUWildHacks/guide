...
**Urban Planning** invites participants to explore the fusion of technology, sustainability, and community development to reshape the urban environment. Whether this is by tackling challenges like efficient public transportation systems, sustainable infrastructure, or smart city technologies that improve quality of life, you have the freedom to go in any direction you like.

### Productivity

**Productivity** is designed for visionaries eager to redefine how we work, learn, and manage our daily lives in an increasingly digital world. Participants are challenged to develop innovative tools, apps, and systems that boost efficiency, enhance time management, and improve overall productivity for individuals and organizations alike.

### Wellness

**Wellness** invites innovators to focus on enhancing physical, mental, and emotional wellbeing in a world where health often takes a backseat to our busy lives. Participants have the opportunity to create apps, devices, and platforms that promote healthy living, mental health awareness, stress reduction, and more.
...
_Presented by Capital One_

Our challenge is the "Best Financial Hack." This is very open ended to allow hackers to be creative and innovative. We look for projects containing anything financial in it, when in doubt ask our mentors if the project applies for our challenge. We also provide an API which helps with mock financial data, this is optional.
